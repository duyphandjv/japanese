...
import com.phanduy.tekotest.utilities.Converters
import com.phanduy.tekotest.utilities.DATABASE_NAME
...
//            Log.e("Duyuno","Duyuno build data base")
            return Room.databaseBuilder(context, AppDatabase::class.java, DATABASE_NAME)
                    .addCallback(object : RoomDatabase.Callback() {
                        override fun onCreate(db: SupportSQLiteDatabase) {
                            super.onCreate(db)
//                            Log.e("Duyuno","Duyuno build data base -> onCreate")
//                            val request = OneTimeWorkRequestBuilder<LocalDataLoader>().build()
